...
namespace StandardEng.Web.Controllers
{
    public class NotesController : BaseController
    {
        ...
        private readonly GenericRepository<tblNote> _dbRepository;

        #endregion
        #region Constructor
        public NotesController()
        {
            _dbRepository = new GenericRepository<tblNote>();
        }
        #endregion
        ...
        public ActionResult KendoSave([DataSourceRequest] DataSourceRequest request, tblNote model)
        {
        ...
        public ActionResult KendoDestroy([DataSourceRequest] DataSourceRequest request, tblNote model)
        {
